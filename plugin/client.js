 ...
 * file's module export as `code.client`. The file exports a factory
 * function whose body is exactly what the Host records as the Plugin source;
 * `plugin/client.raw.js` contains the bare function body without the wrapper.
 */

'use strict'

module.exports = function clientHalf() {
const I18N = {
  'zh-CN': {
