 ...
 * file's module export as `code.host`. The file exports a factory
 * function whose body is exactly what the Host records as the Plugin source;
 * `plugin/host.raw.js` contains the bare function body without the wrapper.
 */

'use strict'

module.exports = function hostHalf() {
